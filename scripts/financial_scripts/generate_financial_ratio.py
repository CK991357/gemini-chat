...
def main():
    parser = argparse.ArgumentParser(description='生成多年度财务比率 Markdown 报告')
    parser.add_argument('--input', '-i', required=True, help='financial_ratio_result.json 路径')
    parser.add_argument('--output', '-o', default='financial_report.md', help='输出 Markdown 文件路径')
    args = parser.parse_args()

    generator = MDFinancialReportGenerator(args.input)
