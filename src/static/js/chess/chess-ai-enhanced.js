...
**特别注意：**
- **当前是${currentTurn}回合，必须使用${requiredCase}！**
...
**你的输出应该是一个逗号分隔的SAN字符串列表，例如 "Nf6, O-O, exd5"。（根据回合方决定大小写）**`;
    }
