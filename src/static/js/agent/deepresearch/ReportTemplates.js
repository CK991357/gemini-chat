...
export const ReportTemplates = {
    ...
    academic: {
        ...
        config: {
            ...
            structure: [
                "# [基于论文标题和核心贡献自主生成的深刻标题]",
                "## 一、论文基础信息 (Paper Metadata)",
                "   - **论文标题**: [自动提取]",
                "   - **作者信息**: [列出所有作者及机构]",
                "   - **发表信息**: [会议/期刊，年份，DOI/链接]",
                "   - **核心贡献**: [用一句话总结论文的最核心价值]",
                
                "## 二、研究背景与问题定义 (Research Background & Problem Definition)",
                "   - [深入分析该研究领域的发展脉络和现有挑战]",
                "   - [清晰界定本文要解决的具体问题及其重要性]",
                "   - [阐述该问题在学术和实际应用中的意义]",
                
                "## 三、方法论深度解析 (Methodology Deep Dive)",
                "   - **技术路线**: [详细解析论文采用的技术路线和理论框架]",
                "   - **创新点分析**: [识别并分析论文中的核心创新点]",
                "   - **实现细节**: [关键算法、模型架构或实验设计的详细说明]",
                "   - **理论支撑**: [分析论文的理论基础和数学推导]",
                
                "## 四、实验设计与结果分析 (Experiments & Results Analysis)",
                "   - **实验设置**: [数据集、评估指标、基线方法等]",
                "   - **核心结果**: [关键实验数据和性能指标]",
                "   - **结果验证**: [对实验结果的可信度和统计显著性分析]",
                "   - **消融研究**: [如有，分析各组件的重要性]",
                
                "## 五、相关工作深度对比 (Related Work Deep Comparison)",
                "   - [选取2-3篇最相关的前沿论文进行深度对比]",
                "   - **方法演进**: [分析技术路线的演进过程和突破点]",
                "   - **性能对比**: [在相同指标下的性能对比分析]",
                "   - **优劣分析**: [各方法的优势和局限性]",
                
                "## 六、贡献与局限性分析 (Contributions & Limitations)",
                "   - **学术贡献**: [理论、方法、应用层面的具体贡献]",
                "   - **实际价值**: [对工业界或实际问题的价值]",
                "   - **局限性**: [客观分析论文的局限性和不足]",
                "   - **可复现性**: [分析论文结果的可复现性]",
                
                "## 七、研究脉络与领域演进 (Research Context & Field Evolution)",
                "   - **历史脉络**: [该研究方向的关键发展里程碑]",
                "   - **当前态势**: [该领域当前的研究热点和竞争格局]",
                "   - **技术路线图**: [主要技术路线的发展路径]",
                ...
                "## 九、总结与启示 (Conclusion & Implications)",
                "   - **核心洞见**: [从该论文中得出的最重要洞见]",
                "   - **领域影响**: [对该研究领域的长期影响预测]",
                "   - **实践建议**: [对后续研究者的具体建议]"
            ],
            ...
            style: "学术严谨、深度分析、前瞻视角、批判性思维",
            requirements: "必须基于论文原文和相关工作的深入分析，提供批判性思考和前瞻性预测。每个论点都需要有充分的证据支持，避免简单的内容摘要。"
        },
