...
`
    ...
    shopping_guide: {
        name: "奢侈品专业对比分析报告",
        description: "基于最新市场数据、专业评测和真实用户反馈的深度对比分析报告，支持单产品深度分析和多产品对比",
        config: {
            dynamic_structure: true,
            ...
            structure: [
                "# [自主生成专业标题，体现分析核心]",
                "## 📋 分析执行摘要",
                "   - [300-500字浓缩结论，突出关键发现和个性化推荐]",
                "",
                "## 一、分析背景与需求解析",
                "### 1.1 用户需求深度解读",
                "   - **分析主体**: [明确分析的单品或对比组合]",
                "   - **核心诉求**: [用户最关心的维度，如价格、材质、肤质适配等]",
                "",
                "## 二、产品深度技术调研",
                "### [自主生成产品/品牌名称]",
                "   - **官方技术参数**: [基于搜索结果，提炼关键材质/成分、规格、工艺]",
                "   - **设计理念**: [分析设计哲学、目标人群、风格定位]",
                "",
                "[可选] ### 对比产品/竞品分析",
                "   - [根据搜索情况，自动发现并分析相关竞品或对比产品]",
                "",
                "## 三、专业数据对比分析",
                "### 3.1 [自主组织对比矩阵]",
                "   - [建议包含：价格、材质/成分、设计风格、适用场景等维度]",
                "   - [示例表格，可自主调整：",
                "     | 对比维度 | 产品A | 产品B | 关键差异 |",
                "     |----------|-------|-------|----------|",
                "     | 价格 | ¥X,XXX | ¥X,XXX | 差异分析 |",
                "     | 材质 | [具体] | [具体] | 技术差异 |]",
                "     | **[可选] 尺寸/规格** | [具体数据] | [具体数据] | [实用差异] |",
                "     | **[可选] 设计风格** | [风格描述] | [风格描述] | [审美差异] |",
                "     | **[可选] 适用场合** | [场合列表] | [场合列表] | [场景差异] |]",
                "",
                "### 3.2 专业评测与用户反馈",
                "   - **权威评测**: [整合专业媒体、行业报告的客观评价]",
                "   - **真实体验**: [精选高质量用户反馈，注意时效性和真实性]",
                "",
                "## 四、多维度深度分析",
                "### 4.1 价值与实用性分析",
                "   - **性价比评估**: [基于材质/成分和价格的综合评估]",
                "   - **使用场景适配**: [分析不同场景下的适用性，如日常、正式、旅行等不同场景]",
                "   - **[可选] 保值率分析**: [二手市场表现和经典程度]",
                "",
                "### 4.2 风险与不足识别",
                "   - **质量与适配风险**: [识别常见问题、特定肤质/体型不适配情况]",
                "   - **购买与维护考量**: [渠道选择、假货识别、保养难度等]",
                "",
                "## 五、个性化匹配度评估",
                "### 5.1 基于用户需求的匹配分析",
                "   - [根据用户提供的具体信息（如肤质、预算、使用场景）进行针对性评估]",
                "",
                "### 5.2 [自主生成推荐场景或方案]",
                "   - [示例：日常通勤推荐、正式场合选择、性价比之选等]",
                "",
                "## 六、专业购买建议",
                "### 6.1 综合推荐",
                "   - [基于以上分析，给出明确的购买优先级和建议]",
                "",
                "### 6.2 购买策略",
                "   - **渠道建议**: [官网、专柜、免税店等优劣势分析]",
                "   - **时机建议**: [促销周期、最佳购买时间]",
                "",
                "## 七、使用与维护指南",
                "### 7.1 使用建议",
            ...
            wordCount: "3000-5000字（以分析深度为准）",
            style: "专业细致、数据驱动、分析深入、实用导向",
            
            requirements: `
 "请基于最新市场数据、专业评测和真实用户反馈进行深度分析，确保数据准确性和时效性。报告结构清晰，分析深入，提供个性化匹配建议。"`
        },
