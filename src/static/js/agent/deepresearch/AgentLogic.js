...
### 抓取重点：
1. **最新动态**：最近3个月的新闻报道、技术博客
2. **技术解析**：底层原理、技术白皮书
3. **应用案例**：早期采用者、试点项目

### 时效性要求：
- 必须包含 **最近6个月** 的信息
- 优先抓取 **技术发布会**、**开发者大会** 相关内容
- 关注 **GitHub趋势**、**技术论坛热议** 话题
...
**信息缺失处理：**
1. **论文原文缺失**：尝试搜索论文的**技术博客解析**或**会议演讲稿**作为替代
...
**信息缺失处理：**
1. **最新动态缺失**：将搜索范围扩大到**国际技术媒体**和**顶级会议**
2. **技术原理模糊**：搜索**技术白皮书**或**发明人访谈**
3. **应用案例不足**：搜索**早期采用者**或**风险投资报告**

**前瞻性保障：**
- 即使信息不完整，也必须基于现有趋势给出**大胆但有依据的预测**
- 明确指出**预测的风险**和**不确定性**
`,
