...
| **前沿技术模式** | \`cutting_edge\` | 对新兴技术的深度分析、发展脉络与应用前景评估。 | 前瞻性、深度分析的技术趋势报告（约1800-2500字）。 |
| **奢侈品导购模式** | \`shopping_guide\` | 高端商品的深度对比分析，提供专业购买建议。 | 专业细致、数据驱动的导购分析报告（约2000-3000字）。 |
